...
<div class="flex flex-col bg-gymhunt-purple-2 bg-[url('/public/img/backAvaliaçao.svg')]" x-data="{
    imageOpen: false,
    editOpen: false,
    ...
    <div x-data="{
        ...
        <div class="flex flex-rol font-poppins text-white space-x-3 ml-12 mt-12 mb-8">
            <div class="">                     
        ...
        <div class="mx-12"> <!---->
            <div class="flex flex-row space-x-3">
                ...
                <button class="rounded-xl px-2 py-1 bg-slate-200 shadow-lg"> <i class="fa-solid fa-plus "></i> Nota </button>
            </div>
